...
<head>
    ...
    <title>Scientific library of NSTU | Manage Authors</title>
...
{               ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->Surname);?></td>
                                            <td class="center"><?php echo htmlentities($result->Firstname);?></td>
                                            <td class="center"><?php echo htmlentities($result->DateOfBirth);?></td>
                                            <td class="center"><?php echo htmlentities($result->DateOfDeath);?></td>
                                            <td class="center"><?php echo htmlentities($result->CityOfBirth);?></td>
